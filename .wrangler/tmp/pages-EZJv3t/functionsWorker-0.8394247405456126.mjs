...
async function onRequest4(context) {
  ...
  try {
    ...
    const hashAdmin = await hashPassword2("admin");
    const hashSilva = await hashPassword2("silva123");
    const hashPerera = await hashPassword2("perera123");
    const hashFernando = await hashPassword2("fernando123");
    const statements = [
...
async function onRequest7(context) {
  ...
  if (request.method === "POST") {
    try {
      ...
      const hashed = await hashPassword3(password);
      await db.prepare(
...
// ../.wrangler/tmp/pages-EZJv3t/functionsRoutes-0.9846733427274972.mjs
var routes = [
  {
    routePath: "/api/auth",
    mountPath: "/api",
...
// C:/Users/Sejan/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/Sejan/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-inRIDx/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-inRIDx/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8394247405456126.mjs.map
